...
pub struct PlaybackPreferences {
    #[serde(default = "default_stream_action")]
    pub stream_action: String,
    #[serde(default = "default_external_player_template")]
...
impl Default for PlaybackPreferences {
    fn default() -> Self {
        Self {
            stream_action: default_stream_action(),
            external_player_template: default_external_player_template(),
        }
    }
}

fn default_stream_action() -> String {
    "copy".to_string()
}

fn default_external_player_template() -> String {
    "vlc://{url}".to_string()
}
